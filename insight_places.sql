...
--
-- Host: 127.0.0.1    Database: insight_places
-- ------------------------------------------------------
...
CREATE TABLE `proprietarios` (
  `proprietario_id` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `nome` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `cpf_cnpj` varchar(20) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `contato` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2026-06-05 10:30:40
